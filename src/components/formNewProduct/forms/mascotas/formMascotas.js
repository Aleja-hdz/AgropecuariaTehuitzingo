                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {opcProduct === 'Alimento' && (
                        <>
                            ...
                            <p style={{fontSize:'13px', fontWeight:'400'}} className='new-product-text'>NOTA: Si desea agregar más de una especie o tamaño de animal, precione la tecla "ctrl" y seleccione las especies.</p>
                            <div className='new-product-box2'>
                                <div className='new-product-box1'>
                                    <label>Especie *</label>
                                    <select 
                    ...
                    {opcProduct === 'Accesorio' && (
                        <>
                        <p style={{fontSize:'13px', fontWeight:'400'}} className='new-product-text'>NOTA: Si desea agregar más de una especie de animal, precione la tecla "ctrl" y seleccione las especies.</p>
                            <div className='new-product-box2'>
                                <div className='new-product-box1'>
                                    <label>¿Qué es? *</label>
                                    <select 
