          ...
          <div className="producto-info">
            ...
            <div className="producto-details">
              <div className="detail-row">
                <strong>Peso/Contenido:</strong>
                <span>{product.weight}</span>
              </div>
              
              <div className="detail-row">
                <strong>Especie:</strong>
                <span>{product.especie || 'No especificado'}</span>
              </div>
              ...
              <div className="detail-row">
                <strong>Alimento para producción:</strong>
                <span>{product.alimento_produccion ? 'Sí' : 'No'}</span>
              </div>
              
              {product.materias_primas && (
                <div className="detail-row">
                  <strong>Materias primas:</strong>
                  <span>{product.materias_primas}</span>
                </div>
              )}
